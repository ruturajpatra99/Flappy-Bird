...
rotatedPipe = pygame.image.load("gallery/sprites/rotated_pipe.png").convert_alpha()

# sounds
point = pygame.mixer.Sound("gallery/audio/sounds_sfx_point.wav")
hit = pygame.mixer.Sound("gallery/audio/sounds_sfx_hit.wav")

# Game Caption
pygame.display.set_caption("Flappy Bird By Ruturaj")  
